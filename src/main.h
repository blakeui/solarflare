...
static const unsigned int MAX_TX_COMMENT_LEN = 140; // Solarflarecoin: 128 bytes + little extra

static const int64 MIN_TX_FEE = 100000;
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64 MAX_MONEY = 20000000 * COIN; // Solarflarecoin money supply: maximum of 20M coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 360 / 250; //360 blocks found X day
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("0412345678900004567890000111222333444555666777888999000000aaaaabbbbbcccccdddddeeeeeff00ff00ff00ff001234567890abcdef0022446688abc89")))
