...
{
    BOOST_CHECK(TestSplitHost("www.solarflarecoin.org", "www.solarflarecoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.solarflarecoin.org]", "www.solarflarecoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.solarflarecoin.org:80", "www.solarflarecoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.solarflarecoin.org]:80", "www.solarflarecoin.org", 80));
